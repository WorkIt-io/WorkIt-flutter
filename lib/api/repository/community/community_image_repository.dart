...
final communityImageRepositoryProvider =
    Provider<CommunityImageRepository>((ref) {
  final storageApi = ref.watch(storageApiProvider);
  return CommunityImageRepository(storageApi, ref);
});

class CommunityImageRepository {
  CommunityImageRepository(this._storageApi, this._ref);

  final StorageApi _storageApi;
  final ProviderRef _ref;

  String get path => 'communities/$getCommunityId/images';

  String get getCommunityId => _ref.read(communityIdProvider);
  ...
  Future<String> uploadCommunityImage(File image, String imageId) async {
